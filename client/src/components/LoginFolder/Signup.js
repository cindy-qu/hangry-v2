    ...
    <div>
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <svg fill="#365ca4" className="w-10 h-10 mx-auto" viewBox="0 -0.5 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" >
                    <g>
                ...
                <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-purple-font">Create an account to bookmark restaurants</h2>
            </div>

            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div>
                        <label forhtml="email" className="block text-sm font-medium leading-6 text-purple-font">Email address</label>
                        <div className="mt-2">
                    ...
                    <div>
                        <div className="flex items-center justify-between">
                            <label forhtml="password" className="block text-sm font-medium leading-6 text-purple-font">Password</label>

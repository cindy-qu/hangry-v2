...
const NavBar = ({ setLoginUpdate, loginUpdate, setUpdateNavLogin, setUpdateNavLogout }) => {
  ...
  return (
    <div className="border-gray-200 bg-purple-background dark:bg-gray-800 dark:border-gray-700 text-purple-font items-center">
      <div className="max-w-[1400px] flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={navVisible} id="navbar-solid-bg">
          <ul className="flex flex-col font-medium mt-4 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700 items-center">
            <li>
              <NavLink

...
const Landing = () => {
  ...
  const styles = {
    header: {
      backgroundImage:
        "url(https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80)",
      height: "100vh",
  ...
  return (
    ...
    font-black text-dark-color pt-20 text-center"
        ...
        <h2
          className="font-nunito font-bold text-dark-color 
    pt-10 
    text-left 
    ...
    "
        >
          Let Hangry decide for you!
        </h2>
        <div className="flex justify-center">
          <button
            onClick={handleClick}
            className="font-nunito font-bold px-7 py-2 rounded-lg  text-2xl bg-sky-700 hover:bg-sky-800 text-white mt-20"
          >
            Enter{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"

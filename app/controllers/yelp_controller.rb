...
class YelpController < ApplicationController
  skip_before_action :authorize
    ...
    def search
        ...
        rest_distance = params[:distance]
        response = RestClient::Request.execute(
          method: "GET",
          url: "https://api.yelp.com/v3/businesses/search?term=#{rest_cuisine}&latitude=#{rest_latitude}&longitude=#{rest_longitude}&price=#{rest_price}&radius=#{rest_distance}&limit=20",
